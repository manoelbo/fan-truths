      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="max-w-6xl mx-auto text-center space-y-12">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-800 max-w-4xl mx-auto leading-relaxed">
            A cutting-edge methodology that combines field research, social media analysis, and AI to help you uncover what your customers truly love about your brand—the unique elements that only you can offer.
          </p>
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-[1fr_auto_1fr] gap-8 items-center">
          <CTACard
            ...
            color="bg-white"
          />
          <div className="text-4xl font-bold text-black text-center">or</div>
          <CTACard
